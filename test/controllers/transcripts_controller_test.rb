...
class TranscriptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transcript" do
    assert_difference("Transcript.count") do
      post transcripts_url, params: { transcript: { duration: @transcript.duration, transcriptable_id: @transcript.transcriptable_id, transcriptable_type: @transcript.transcriptable_type, url: @transcript.url } }
    end
  ...
  test "should update transcript" do
    patch transcript_url(@transcript), params: { transcript: { duration: @transcript.duration, transcriptable_id: @transcript.transcriptable_id, transcriptable_type: @transcript.transcriptable_type, url: @transcript.url } }
